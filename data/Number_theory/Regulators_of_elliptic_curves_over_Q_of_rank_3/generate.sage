...
Es = list(db.ec_curves.search({'conductor':{'$lte':140000},'rank':3}))
EsMW = list(db.ec_mwbsd.search({'conductor':{'$lte':140000},'ngens':3}))
'''
...
path = 'data/Number_theory/Regulators_of_elliptic_curves_over_Q_of_rank_3'
