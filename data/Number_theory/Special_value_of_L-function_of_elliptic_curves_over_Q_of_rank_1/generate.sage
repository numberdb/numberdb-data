...
path = 'data/Number_theory/Special_value_of_L-function_of_elliptic_curves_over_Q_of_rank_1'
...
load(os.path.join(path,'ec_Nmax_1000_rank_1_opt.sage')) 
...
for E in Es:
	...
	for prec_factor in prec_factors:
		number = E.lseries().taylor_series(a=1,series_prec=2,prec=prec_factor*RIFprec.prec())[1]*factorial(1)
