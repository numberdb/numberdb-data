...
path = 'data/Number_theory/Special_value_of_L-function_of_elliptic_curves_over_Q_of_rank_3'
...
load(os.path.join(path,'ec_Nmax_140000_rank_3_opt.sage')) 
...
for E in Es:
	...
	for prec_factor in prec_factors:
		number = E.lseries().taylor_series(a=1,series_prec=4,prec=prec_factor*RIFprec.prec())[3]*factorial(3)
