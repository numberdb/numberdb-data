...
Es = list(db.ec_curves.search({'conductor':{'$lte':630},'rank':1}))
EsMW = list(db.ec_mwbsd.search({'conductor':{'$lte':630},'ngens':1}))
'''
...
path = 'data/Number_theory/Regulators_of_elliptic_curves_over_Q_of_rank_1'
...
load(os.path.join(path,'ec_Nmax_630_rank_1.sage')) 
