...
path = 'data/Series_expansions/Q-expansion_of_the_Eisenstein_series_E6/'
...
E6_q_expansion = eisenstein_series_qexp(6,n_max+1,normalization='constant')

numbers = {str(n): str(E6_q_expansion[n]) for n in n_range}
